...
class AnimalViewModel : ViewModel() {
    ...
    private val _animalListState = mutableStateOf<BaseResponse<List<ResponseAnimalListDto>>?>(null)
    val animalListState: State<BaseResponse<List<ResponseAnimalListDto>>?> get() = _animalListState
